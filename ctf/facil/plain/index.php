...
<head>
	...
	<title>Reto CTF: Plain</title>
</head>
<body class="body-bg">
	
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Reto Plain</h1>
			<p class="text-center mb-0">Un mago se ha dejado la flag en el codigo mientras huia con su escoba. ¿Podrás encontrarla?</p>
			<!--core{areufr} -->
		</div>
			...
			<div class="col-12 col-lg-6">
				<div class="border border-secondary rounded-3 p-4 h-100">
					...
					<form id="flag-form" class="d-flex flex-column gap-2">
						...
						<button type="submit" class="btn btn-outline-light mt-2">Entregar flag</button>
					</form>
				</div>
			</div>
		</div>
