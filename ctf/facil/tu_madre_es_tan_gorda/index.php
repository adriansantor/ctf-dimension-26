...
$challengeId = 'tu_madre_es_tan_gorda';
...
<head>
	...
	<title>Tu madre</title>
</head>
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
        			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Tu madre</h1>
        			<p class="text-center" style="font-size: 1.5rem;">tu madre bro</p>
        			<div class="text-center mt-3">
        				<a href="/facil/tu_madre_es_tan_gorda/tu_madre_esta_tan_gorda.zip" class="btn btn-outline-light btn-lg">Descargar Archivo ZIP</a>
        			</div>
        		</div>
        </div>
			...
			<div class="col-12 col-lg-5">
				<div class="border border-secondary rounded-3 p-4 h-100">
					...
					<form id="flag-form" class="d-flex flex-column gap-2">
						...
						<input id="flag-input" name="flag" type="text" class="form-control bg-dark text-white border-secondary" placeholder="core{...} "placeholder="core{...}" required autocomplete="off" />
