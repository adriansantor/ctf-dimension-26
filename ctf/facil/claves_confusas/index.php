...
<head>
	...
	<title>Claves confusas</title>
</head>
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Claves confusas</h1>
			<p class="text-center" style="font-size: 1.5rem;">
                Hemos interceptado un mensaje con las notas de Seguridad de la Información,
                pero está cifrado de tal manera que solo podremos verlo si conocemos un código secreto.
                El código ha sido cifrado usando RSA usando e=7 p=3 y q=11, con lo que hemos recibido como resultado 3.
                Nos ayudas a averiguar el código original?
            </p>
		</div>
			...
			<div class="col-12 col-lg-5">
				<div class="border border-secondary rounded-3 p-4 h-100">
					...
					<form id="respuesta-form" class="d-flex flex-column gap-2">
						<label for="respuesta-input" class="form-label mb-0">Cuál es el código original?</label>
