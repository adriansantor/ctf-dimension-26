...
<head>
	...
	<title>Reto CTF: Torre de Babel</title>
</head>
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Reto Torre de Babel</h1>
		</div>
			...
			<div class="col-12 col-lg-5">
				<div class="border border-secondary rounded-3 p-4 h-100">
					...
					<form id="respuesta-form" class="d-flex flex-column gap-2">
						<label for="respuesta-input" class="form-label mb-0">Convierte "nostromo_roba_puertas" a base64 e introduce el resultado</label>
