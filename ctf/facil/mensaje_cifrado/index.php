...
<main class="container py-4">
    <div class="row align-center g-4 mb-4">
        <h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Mensaje cifrado</h1>
    </div>

    <div class="row justify-content-center g-4">
        <div class="col-12 col-lg-10">
            <div class="border border-secondary rounded-3 p-4 h-100 mb-4 text-center">
                <p class="mb-3 fs-5">Nos ha llegado este mensaje, ayudanos a descifrarlo.</p>
                <p class="font-monospace fs-1 mb-0" style="letter-spacing: 0.06em;">CpchQbspvJlzhy</p>
            </div>
        </div>
    </div>
        ...
        <div class="col-12 col-lg-5">
            <div class="border border-secondary rounded-3 p-4 h-100">
                ...
                <form id="respuesta-form" class="d-flex flex-column gap-2">
                    <label for="respuesta-input" class="form-label mb-0">Cual es el contenido del mensaje?</label>
                    <input
                        id="respuesta-input"
                        name="respuesta"
                        type="text"
