...
<head>
	...
	<title>Reto: Color</title>
</head>
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Colorín Colorado</h1>
		</div>

		<div class="row g-4 justify-content-center">
			<div class="col-12 col-lg-5">
				<div class="border border-secondary rounded-3 p-4 h-100">
					<h2 class="h3 fw-bold mb-3">¿Cuál es este color?</h2>
					<form id="respuesta-form" class="d-flex flex-column gap-2">
						<label for="respuesta-input" class="form-label mb-0">Los colores suelen ser identificados mediante un código. Dicho esto: ¿Cuál es el color que predomina en esta imagen?</label>
						<div class="text-center mb-3">
							<img src="/facil/colorido/harrypotterminimalista.jpg" alt="Imagen sospechosa" class="img-fluid border border-secondary rounded-2" style="max-height: 220px; width: auto;">
							<div class="mt-2">
								<a href="/facil/colorido/harrypotterminimalista.jpg" download class="btn btn-outline-light">Descargar imagen</a>
							</div>
						</div>
