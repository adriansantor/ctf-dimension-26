...
<head>
	...
	<title>Reto: Búsqueda por la Red</title>
</head>
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Búsqueda por la Red</h1>
		</div>

		<div class="row g-4 justify-content-center">
			<div class="col-12 col-lg-5">
				<div class="border border-secondary rounded-3 p-4 h-100">
					<h2 class="h3 fw-bold mb-3">¿Quién es @CoreDumpedHater?</h2>
					<form id="respuesta-form" class="d-flex flex-column gap-2">
						<label for="respuesta-input" class="form-label mb-0">Hay una pequeña criatura rondando la Red, tirando hate a una de las asociaciones de la ETSISI... ¿Quién será el responsable de tales actos obscenos?</label>
