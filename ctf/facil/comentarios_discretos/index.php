...
$challengeId = 'comentarios_discretos';
...
<head>
	...
	<title>Reto: El profesor satisfactorio</title>
</head>
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">El Profesor Satisfactorio</h1>
		</div>
