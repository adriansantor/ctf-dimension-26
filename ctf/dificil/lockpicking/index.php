...
<head>
	...
	<title>Reto CTF: Lockpicking</title>
</head>
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Reto Lockpicking</h1>
		</div>

		<div class="row justify-content-center mb-4">
			<div class="col-12 col-lg-8">
				<div class="border border-secondary rounded-3 p-4">
					<p class="mb-0">En una torre olvidada, tras una puerta de hierro que susurra en latin, descansa un candado encantado. No pide acertijos ni contrasenas, solo pulso, paciencia y un toque de magia. Si logras abrirlo, una lechuza sin remitente dejara la flag en tus manos antes de que el eco se apague.</p>
				</div>
			</div>
		</div>
