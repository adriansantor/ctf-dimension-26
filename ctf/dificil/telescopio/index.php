...
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Informacion privilegiada</h1>
		</div>
		...
		<div class="row justify-content-center g-4">
			<div class="col-12 col-lg-10">
				<div class="border border-secondary rounded-3 p-4 h-100 mb-4">
					...
					<p>Para conseguir la flag de este reto tendras que buscar la manera de enganar al sistema leyendo lo que no debes.</p>
					<p>Actualmente el sistema nos identifica como un usuario normal y no nos deja hacer nada interesante. Sin embargo, sabemos que se esta filtrando informacion privilegiada de la empresa en nuestra propia sesion. Busca la manera de encontrar esa contraseña secreta y pegala aqui abajo.</p>
