...
<head>
	...
	<title>Reto CTF: Fantasma</title>
</head>
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Reto Fantasma</h1>
		</div>
		...
		<div class="row justify-content-center mb-4">
			<div class="col-12 col-lg-8">
				<div class="border border-secondary rounded-3 p-4">
					...
					<p class="mb-2">Hemos capturado un audio embrujado. La flag esta escondida en su espectrograma.</p>
					<div class="d-flex flex-wrap gap-2 align-items-center">
						<a href="/medio/fantasma/fantasma.wav" download class="btn btn-outline-light">Descargar fantasma.wav</a>
						<audio controls preload="none" src="/medio/fantasma/fantasma.wav"></audio>
					</div>
				</div>
			</div>
		</div>
