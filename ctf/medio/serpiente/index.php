...
<head>
	...
	<title>Reto CTF: Serpiente</title>
</head>
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Reto Serpiente</h1>
		</div>
		...
		<div class="row justify-content-center mb-4">
			<div class="col-12 col-lg-8">
				<div class="border border-secondary rounded-3 p-4">
					...
					<p class="mb-2">Aquí te dejamos la flag, pero alguien de CDIA la ha codificado. Hemos conseguido el script que han usado para hacerlo, tendrás que revertirlo</p>
					<p class="mb-2">Texto codificado:</p>
					<p class="mb-3"><code>18d0b886df6d883d75</code></p>
					<a href="/medio/serpiente/serpiente.py" download class="btn btn-outline-light">Descargar serpiente.py</a>
				</div>
			</div>
		</div>
