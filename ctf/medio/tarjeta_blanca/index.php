...
<head>
	...
	<title>Reto: Tarjeta Blanca</title>
</head>
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Tarjeta Blanca</h1>
		</div>
			<div class="col-12 col-lg-5">
				<div class="border border-secondary rounded-3 p-4 h-100">
					<h2 class="h3 fw-bold mb-3">Misión</h2>
					<p class="mb-3">En los pasillos de Hogwarts ha aparecido un aparato misterioso parecido a un artefacto muggle. Tu objetivo es usarlo para leer el código NFC oculto en una tarjeta encantada y desvelar la clave correcta.</p>
					<form id="flag-form" class="d-flex flex-column gap-2">
						<label for="flag-input" class="form-label mb-0"></label>
