...
<head>
	...
	<title>Reto CTF: Regex</title>
</head>
<body class="body-bg">
	<main class="container py-4">
		<div class="row align-center g-4 mb-4">
			<h1 class="text-center" style="font-family: 'VT323', monospace; font-size: 6rem;">Reto Regex</h1>
		</div>

		<div class="row justify-content-center mb-4">
			<div class="col-12 col-lg-8">
				<div class="border border-secondary rounded-3 p-4">
					<h2 class="h3 fw-bold mb-3">Mision</h2>
					<p class="mb-3">Descarga el archivo de ruido, usa grep y expresiones regulares, y encuentra la unica linea que esconde la flag.</p>
					<p class="mb-2 fw-bold">Pistas:</p>
					<ul class="mb-3">
						<li>Hazlo con una sola orden grep usando 4 condiciones regex en la misma expresion.</li>
						<li>Condicion 1: la linea no puede empezar por b.</li>
						<li>Condicion 2: la linea debe contener la cadena asdasd.</li>
